...
SMODS.Joker{ -- Corrupter Steven
    ...
    loc_txt = {
        ...
        text = {
            '{X:dark_edition,E:1,C:white}^1.2{} Chips and gain {X:gold,C:white}$15{} at {C:attention}end of round{}.',
...
SMODS.Joker{ -- Malachite Fusion
    ...
    loc_txt = {
        ...
        text = {
            ...
            'If played hand is a {C:attention}Pair{},',
            'create {C:dark_edition,E:1}negative{} {C:attention}Hanged Man{}, {C:attention}Mercury{},',
...
SMODS.Joker{ -- Corrupter Steven
    ...
    loc_txt = {
        ...
        text = {
            'Each playing card gives {E:1,C:white,X:dark_edition,s:1.25}^^1.5{} {X:dark_edition,C:edition,E:1}Chips&Mult{}',
            'if played hand contains a {C:attention}High Card{}.',

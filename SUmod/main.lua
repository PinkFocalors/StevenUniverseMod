...
SMODS.Joker{ -- Stevonnie
    ...
    loc_txt = {
        name = '{C:legendary,E:1}Stevonnie{}',
        text = {
            ...
            '{C:enhanced,s:0.8}Diamonds... I\'m having Diamond dreams again,{}',
            '{C:enhanced,s:0.8}but why now? Why... here?{}',
            '{C:legendary,s:0.7}- From \"Jungle Moon\"{}'
        }
    },
...
SMODS.Joker{ -- Aventurine (Fusion of Lapis + Peridot) [ has  bucnh of other names too]
    key = 'aventurine',
    loc_txt = {
...
SMODS.Joker{ -- Rainbow Quartz
    ...
    loc_txt = {
        ...
        text = {
            ...
            'each give {X:mult,C:white}X5{} Mult when scored.',
...
SMODS.Joker{ -- Alexandrite
    key = 'alex', --joker key
    loc_txt = {
        name = '{C:tarot,E:1,s:1.7}Alexandrite{}',
        text = {
            'Each played cards give {X:mult,C:white}X25{} Mult and {X:chips,C:white}X25{} Chips when scored,',
            ...
            'If played hand is a {C:attention}Five of a Kind{} or a {C:attention}Flush Five{},',
            'create {C:edition,E:1}A Single Pale Rose{}.',
            '{C:tarot,s:0.8}You{} {C:green,s:0.8,E:2}two{} {C:tarot,s:0.8}should spennd some time apart.{}',
...
SMODS.Joker{ -- Obsidian
    ...
    loc_txt = {
        ...
        text = {
            'Each played card gives {X:mult,C:white}X50{} Mult and {X:chips,C:white}X50{} Chips when scored,',
            ...
            'and a {C:dark_edition,E:1}negative{} {C:attention}The Soul{}.',
...
SMODS.Joker{ -- Volleyball
    ...
    config = {
        extra = {
            perma_x_chips = 0.1, --configurable value
        }
    },
    loc_vars = function(self, info_queue, card)
    ...
    calculate = function(self, card, context)
        if context.individual and context.cardarea == G.play then
            ...
            oc.ability.perma_x_chips = oc.ability.perma_x_chips + 0.1
            return { 
...
SMODS.Joker{ -- Mega Pearl
    key = 'mega', --joker key
    loc_txt = {
        name = '{C:hearts,E:1,s:1.2}Mega Pearl{}',
        text = {

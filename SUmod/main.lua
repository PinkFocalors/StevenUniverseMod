...
SMODS.Atlas{ --- for The Cluster
    key = 'Cluster', --atlas key
    path = 'Cluster.png', --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}
...
SMODS.Atlas{ --- for Pearl Spear
    key = "PearlS", --atlas key
    path = "PearlSpear.png", --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}

SMODS.Atlas{ --- for Opal's Bow
    key = "OpalB", --atlas key
    path = "OpalBow.png", --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}

SMODS.Atlas{ --- for Ruby's Gauntlet
    key = "RubyG", --atlas key
    path = "RubyArm.png", --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}

SMODS.Atlas{ --- for Garnet's Gauntlet
    key = "Gauntlets", --atlas key
    path = "Gauntlets.png", --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}

SMODS.Atlas{ --- for Jasper's Helmet
    key = "JasperH", --atlas key
    path = "JasperHelmet.png", --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}

SMODS.Atlas{ --- for Peridot's Tablet
    key = "PeridotT", --atlas key
    path = "PeridotTablet.png", --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}

SMODS.Atlas{ --- for Amethyst's Whip
    key = "AmethystW", --atlas key
    path = "AmethystWhip.png", --atlas' path in (yourMod)/assets/1x or (yourMod)/assets/2x
    px = 71, --width of one card
    py = 95 -- height of one card
}
...
SMODS.Joker{ -- Spinel
    ...
    loc_txt = { -- local text
        ...
        text = {
            '{C:white,X:chips,E:1}X1.2{} Chips and {X:dark_edition,E:1,C:white}^1.2{} Chips.',
...
SMODS.Joker{
    ...
    config = { extra = { Xmult = 8, Xchips = 8, repetitions = 1, card_limit = 2 } 
    },
    loc_vars = function(self, info_queue, card)
        return {vars = {card.ability.extra.card_limit}}
    end,
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = { --text of card
            'Changes the {C:attention}suit{} of up to {C:attention}5{}',
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = { --text of card
            ...
            'to up to {C:attention}3{} selected playing cards.',
            'Usable {C:attention}once per round{}.'
        }
    },
    credit = {
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = {
            'Applies the {C:attention}Steel{} enhancement to up to {C:attention}3{} selected cards.',
            'Usable {C:attention}once per round{}.'
        }
    },
    credit = {
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = {
            'Applies the {C:attention}Stone{} enhancement to up to {C:attention}3{} selected cards.',
            'Usable {C:attention}once per round{}.'
        }
    },
    credit = {
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = {
            'Applies the {C:attention}Glass{} enhancement to up to {C:attention}3{} selected cards.',
            'Usable {C:attention}once per round{}.'
        }
    },
    credit = {
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = {
            'Applies the {C:tarot}Purple{} seal to up to {C:attention}2{} selected cards.',
            'Usable {C:attention}once per round{}.'
        }
    },
    credit = {
    ...
    use = function(self,card,area,copier)
        for i = 1, #G.hand.highlighted do 
            G.hand.highlighted[i]:set_seal("Purple")
        end
    end,
    keep_on_use = function() return false 
    end,
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = {
            'Applies the {C:red}Red{} seal to up to {C:attention}2{} selected cards.',
            'Usable {C:attention}once per round{}.'
        }
    },
    credit = {
    ...
    use = function(self,card,area,copier)
        for i = 1, #G.hand.highlighted do 
            G.hand.highlighted[i]:set_seal("Red")
        end
    end,
    keep_on_use = function() return false 
    end,
...
SMODS.Consumable{
    ...
    use = function(self,card,area,copier)
        for i = 1, #G.hand.highlighted do 
            G.hand.highlighted[i]:set_seal("Red")
            G.hand.highlighted[i]:set_ability("m_lucky")
        end
    end,
    keep_on_use = function() return false 
    end,
...
SMODS.Consumable{
    ...
    use = function(self,card,area,copier)
        for i = 1, #G.hand.highlighted do 
            G.hand.highlighted[i]:set_ability("m_steel")
            G.hand.highlighted[i]:set_seal("Blue")
        end
    end,
    keep_on_use = function() return false 
    end,
...
SMODS.Consumable{
    ...
    loc_txt = {
        ...
        text = { --text of card
            ...
            'and {C:attention}polychrome{} edition to up to {C:attention}5{} selected {C:attention}playing cards{}.',
            '{C:inactive,s:0.8,E:1}amazing art by @jasbear.art on TikTok{}'
        }
    },
    credit = {
    ...
    apply = function(self)
        G.E_MANAGER:add_event(Event({
            func = function()
                ...
                local pool   = { "sbeven_Gem", "sbeven_CGem" }
...
SMODS.Back{
    ...
    loc_txt = {
        ...
        text = {
            "Start off with {C:legendary}Emerald{}."
        }
    },
        ...
        G.E_MANAGER:add_event(Event({
          func = function()
            ...
            local card = SMODS.add_card{
              key      = "j_sbeven_aventurine", -- your Joker’s key

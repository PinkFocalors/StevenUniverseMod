...
SMODS.Joker{ -- Aventurine/Emerald (Fusion of Lapis + Peridot) [ has  bucnh of other names too]
    ...
    loc_txt = {
        ...
        text = {
            '{X:dark_edition,C:white,E:1}^2 Mult{}.',
...
SMODS.Joker{ -- Rainbow Quartz
    ...
    loc_txt = {
        ...
        text = {
            ...
            'each give {X:mult,C:white}X5{} Mult and {C:white,X:dark_edition}^1.2 Mult{} when scored.',
...
SMODS.Joker{ -- Obsidian
    ...
    loc_txt = {
        ...
        text = { 
            ...
            'and {C:white,X:dark_edition}^2 Chips&Mult{} when scored,',
            ...
            'and gives {X:dark_edition,C:white}^3 Chips&Mult{}.',

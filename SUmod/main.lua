    ...
    calculate = function(self, card, context)
        ...
        and not context.game_over then
            ...
            if blind.boss then
                ...
                local choices = {
                    { key = 'j_sbeven_pad',           weight = 10    },
                    { key = 'j_sbeven_rutile',        weight = 10    },
                    { key = 'j_sbeven_fluorite',      weight = 10    },
                    { key = 'j_sbeven_rhodonite_off', weight = 10    },
                    { key = 'j_sbeven_black',         weight = 0.00001 }  -- 0.01% chance
                }
